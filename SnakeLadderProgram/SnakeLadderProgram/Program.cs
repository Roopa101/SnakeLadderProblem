...
namespace SnakeLadderProgram
{
    class Program
    {
        public static void Main(string[] args)
        {
            ...
            int count = 0;
            int count2 = 0;
            while (Player1Position <= FinalPosition)
            {
                ...
                int CheckForOptions = random2.Next(0, 3);
                    ...
                    case LadderPosition:
                        ...
                        else if (Player1Position == FinalPosition)
                        {
                            ...
                            while (Player2Position <= FinalPosition)
                            {
                                ...
                                int CheckForOptions2 = random4.Next(0, 3);

                                switch (CheckForOptions2)
                                {
                                    case LadderPosition:
                                        Player2Position = Player2Position + DiceRoll2;
                                        //Here to prevent the player position to surpass the winning position we have to give the if condition.
                                        if (Player2Position > FinalPosition)
                                        {
                                            Player2Position = Player2Position - DiceRoll2;
